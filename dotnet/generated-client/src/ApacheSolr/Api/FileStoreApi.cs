...
namespace ApacheSolr.Api
{
    ...
    public partial class FileStoreApi : IDisposable, IFileStoreApi
    {
        ...
        /// <returns></returns>
        public FileStoreApi(ApacheSolr.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public FileStoreApi(HttpClient client, ApacheSolr.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public FileStoreApi(ApacheSolr.Client.ISynchronousClient client, ApacheSolr.Client.IAsynchronousClient asyncClient, ApacheSolr.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = DeleteFileWithHttpInfo(path, localDelete);
        ...
        /// <param name="localDelete">Indicates whether the deletion should only be done on the receiving node.  For internal use only (optional)</param>
        /// <returns>ApiResponse of SolrJerseyResponseModel</returns>
        public ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> DeleteFileWithHttpInfo(string path, bool? localDelete = default(bool?))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'path' when calling FileStoreApi->DeleteFile");
            ...
            localVarRequestOptions.PathParameters.Add("path", ApacheSolr.Client.ClientUtils.ParameterToString(path)); // path parameter
            if (localDelete != null)
            {
                localVarRequestOptions.QueryParameters.Add(ApacheSolr.Client.ClientUtils.ParameterToMultiMap("", "localDelete", localDelete));
            }
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = await DeleteFileWithHttpInfoAsync(path, localDelete, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SolrJerseyResponseModel)</returns>
        public async System.Threading.Tasks.Task<ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel>> DeleteFileWithHttpInfoAsync(string path, bool? localDelete = default(bool?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'path' when calling FileStoreApi->DeleteFile");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = GetFileWithHttpInfo(path, sync, getFrom, meta);
            return localVarResponse.Data;
        }
        ...
        /// <param name="meta">Indicates that (only) file metadata should be fetched (optional)</param>
        /// <returns>ApiResponse of SolrJerseyResponseModel</returns>
        public ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> GetFileWithHttpInfo(string path, bool? sync = default(bool?), string? getFrom = default(string?), bool? meta = default(bool?))
        {
            // verify the required parameter 'path' is set
            if (path == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'path' when calling FileStoreApi->GetFile");
            ...
            if (sync != null)
            {
                localVarRequestOptions.QueryParameters.Add(ApacheSolr.Client.ClientUtils.ParameterToMultiMap("", "sync", sync));
            }
            if (getFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(ApacheSolr.Client.ClientUtils.ParameterToMultiMap("", "getFrom", getFrom));
            }
            if (meta != null)
            {
                localVarRequestOptions.QueryParameters.Add(ApacheSolr.Client.ClientUtils.ParameterToMultiMap("", "meta", meta));
            }
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = await GetFileWithHttpInfoAsync(path, sync, getFrom, meta, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ApacheSolr.Client.ApiResponse<UploadToFileStoreResponseModel> localVarResponse = UploadFileWithHttpInfo(filePath, body, sig);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sig">Signature(s) for the file being uploaded (optional)</param>
        /// <returns>ApiResponse of UploadToFileStoreResponseModel</returns>
        public ApacheSolr.Client.ApiResponse<UploadToFileStoreResponseModel> UploadFileWithHttpInfo(string filePath, Object body, Collection<string>? sig = default(Collection<string>?))
        {
            // verify the required parameter 'filePath' is set
            if (filePath == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'filePath' when calling FileStoreApi->UploadFile");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'body' when calling FileStoreApi->UploadFile");
            ...
            if (sig != null)
            {
                localVarRequestOptions.QueryParameters.Add(ApacheSolr.Client.ClientUtils.ParameterToMultiMap("multi", "sig", sig));
            }
        ...
        {
            ApacheSolr.Client.ApiResponse<UploadToFileStoreResponseModel> localVarResponse = await UploadFileWithHttpInfoAsync(filePath, body, sig, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
