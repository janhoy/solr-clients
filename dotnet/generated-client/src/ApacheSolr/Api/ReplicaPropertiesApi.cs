...
namespace ApacheSolr.Api
{
    ...
    public partial class ReplicaPropertiesApi : IDisposable, IReplicaPropertiesApi
    {
        ...
        /// <returns></returns>
        public ReplicaPropertiesApi(ApacheSolr.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ReplicaPropertiesApi(HttpClient client, ApacheSolr.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ReplicaPropertiesApi(ApacheSolr.Client.ISynchronousClient client, ApacheSolr.Client.IAsynchronousClient asyncClient, ApacheSolr.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = AddReplicaPropertyWithHttpInfo(collName, shardName, replicaName, propName, addReplicaPropertyRequestBodyModel);
        ...
        /// <param name="addReplicaPropertyRequestBodyModel">The value of the replica property to create or update</param>
        /// <returns>ApiResponse of SolrJerseyResponseModel</returns>
        public ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> AddReplicaPropertyWithHttpInfo(string collName, string shardName, string replicaName, string propName, AddReplicaPropertyRequestBodyModel addReplicaPropertyRequestBodyModel)
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'collName' when calling ReplicaPropertiesApi->AddReplicaProperty");

            // verify the required parameter 'shardName' is set
            if (shardName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'shardName' when calling ReplicaPropertiesApi->AddReplicaProperty");

            // verify the required parameter 'replicaName' is set
            if (replicaName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'replicaName' when calling ReplicaPropertiesApi->AddReplicaProperty");

            // verify the required parameter 'propName' is set
            if (propName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'propName' when calling ReplicaPropertiesApi->AddReplicaProperty");

            // verify the required parameter 'addReplicaPropertyRequestBodyModel' is set
            if (addReplicaPropertyRequestBodyModel == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'addReplicaPropertyRequestBodyModel' when calling ReplicaPropertiesApi->AddReplicaProperty");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = await AddReplicaPropertyWithHttpInfoAsync(collName, shardName, replicaName, propName, addReplicaPropertyRequestBodyModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SolrJerseyResponseModel)</returns>
        public async System.Threading.Tasks.Task<ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel>> AddReplicaPropertyWithHttpInfoAsync(string collName, string shardName, string replicaName, string propName, AddReplicaPropertyRequestBodyModel addReplicaPropertyRequestBodyModel, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'collName' when calling ReplicaPropertiesApi->AddReplicaProperty");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = DeleteReplicaPropertyWithHttpInfo(collName, shardName, replicaName, propName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="propName">The name of the property to delete.</param>
        /// <returns>ApiResponse of SolrJerseyResponseModel</returns>
        public ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> DeleteReplicaPropertyWithHttpInfo(string collName, string shardName, string replicaName, string propName)
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'collName' when calling ReplicaPropertiesApi->DeleteReplicaProperty");

            // verify the required parameter 'shardName' is set
            if (shardName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'shardName' when calling ReplicaPropertiesApi->DeleteReplicaProperty");

            // verify the required parameter 'replicaName' is set
            if (replicaName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'replicaName' when calling ReplicaPropertiesApi->DeleteReplicaProperty");

            // verify the required parameter 'propName' is set
            if (propName == null)
                throw new ApacheSolr.Client.ApiException(400, "Missing required parameter 'propName' when calling ReplicaPropertiesApi->DeleteReplicaProperty");
        ...
        {
            ApacheSolr.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = await DeleteReplicaPropertyWithHttpInfoAsync(collName, shardName, replicaName, propName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
