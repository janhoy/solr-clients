...
namespace ApacheSolr.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReloadCoreRequestBody")]
    public partial class ReloadCoreRequestBodyModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReloadCoreRequestBodyModel" /> class.
        /// </summary>
        /// <param name="async">Request ID to track this action which will be processed asynchronously..</param>
        public ReloadCoreRequestBodyModel(string async = default(string))
        {
            this.Async = async;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReloadCoreRequestBodyModel {\n");
