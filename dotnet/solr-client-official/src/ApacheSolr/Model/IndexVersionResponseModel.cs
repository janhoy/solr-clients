...
{
    /// <summary>
    /// IndexVersionResponseModel
    /// </summary>
    [DataContract(Name = "IndexVersionResponse")]
    public partial class IndexVersionResponseModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexVersionResponseModel" /> class.
        /// </summary>
        ...
        public IndexVersionResponseModel(ResponseHeaderModel responseHeader = default(ResponseHeaderModel), ErrorInfoModel error = default(ErrorInfoModel), long indexversion = default(long), long generation = default(long), string status = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IndexVersionResponseModel {\n");
