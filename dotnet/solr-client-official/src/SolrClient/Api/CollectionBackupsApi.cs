...
namespace SolrClient.Api
{
    ...
    public partial class CollectionBackupsApi : IDisposable, ICollectionBackupsApi
    {
        ...
        /// <returns></returns>
        public CollectionBackupsApi(SolrClient.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CollectionBackupsApi(HttpClient client, SolrClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CollectionBackupsApi(SolrClient.Client.ISynchronousClient client, SolrClient.Client.IAsynchronousClient asyncClient, SolrClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            SolrClient.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = CreateCollectionBackupWithHttpInfo(collectionName, backupName, createCollectionBackupRequestBodyModel);
        ...
        /// <param name="createCollectionBackupRequestBodyModel"> (optional)</param>
        /// <returns>ApiResponse of SolrJerseyResponseModel</returns>
        public SolrClient.Client.ApiResponse<SolrJerseyResponseModel> CreateCollectionBackupWithHttpInfo(string collectionName, string backupName, CreateCollectionBackupRequestBodyModel? createCollectionBackupRequestBodyModel = default(CreateCollectionBackupRequestBodyModel?))
        {
            // verify the required parameter 'collectionName' is set
            if (collectionName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collectionName' when calling CollectionBackupsApi->CreateCollectionBackup");

            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->CreateCollectionBackup");
            ...
            localVarRequestOptions.PathParameters.Add("backupName", SolrClient.Client.ClientUtils.ParameterToString(backupName)); // path parameter
        ...
        {
            SolrClient.Client.ApiResponse<SolrJerseyResponseModel> localVarResponse = await CreateCollectionBackupWithHttpInfoAsync(collectionName, backupName, createCollectionBackupRequestBodyModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SolrJerseyResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<SolrJerseyResponseModel>> CreateCollectionBackupWithHttpInfoAsync(string collectionName, string backupName, CreateCollectionBackupRequestBodyModel? createCollectionBackupRequestBodyModel = default(CreateCollectionBackupRequestBodyModel?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'collectionName' is set
            if (collectionName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collectionName' when calling CollectionBackupsApi->CreateCollectionBackup");
        ...
        {
            SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> localVarResponse = DeleteMultipleBackupsByRecencyWithHttpInfo(backupName, retainLatest, location, repository, async);
            return localVarResponse.Data;
        }
        ...
        /// <param name="async"> (optional)</param>
        /// <returns>ApiResponse of BackupDeletionResponseBodyModel</returns>
        public SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> DeleteMultipleBackupsByRecencyWithHttpInfo(string backupName, int? retainLatest = default(int?), string? location = default(string?), string? repository = default(string?), string? async = default(string?))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->DeleteMultipleBackupsByRecency");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(SolrClient.Client.ClientUtils.ParameterToMultiMap("", "retainLatest", retainLatest));
            }
            if (location != null)
            {
                localVarRequestOptions.QueryParameters.Add(SolrClient.Client.ClientUtils.ParameterToMultiMap("", "location", location));
            }
            if (repository != null)
            {
                localVarRequestOptions.QueryParameters.Add(SolrClient.Client.ClientUtils.ParameterToMultiMap("", "repository", repository));
            }
            if (async != null)
            {
        ...
        {
            SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> localVarResponse = await DeleteMultipleBackupsByRecencyWithHttpInfoAsync(backupName, retainLatest, location, repository, async, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BackupDeletionResponseBodyModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel>> DeleteMultipleBackupsByRecencyWithHttpInfoAsync(string backupName, int? retainLatest = default(int?), string? location = default(string?), string? repository = default(string?), string? async = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->DeleteMultipleBackupsByRecency");
        ...
        {
            SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> localVarResponse = DeleteSingleBackupByIdWithHttpInfo(backupName, backupId, location, repository, async);
            return localVarResponse.Data;
        }
        ...
        /// <param name="async"> (optional)</param>
        /// <returns>ApiResponse of BackupDeletionResponseBodyModel</returns>
        public SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> DeleteSingleBackupByIdWithHttpInfo(string backupName, string backupId, string? location = default(string?), string? repository = default(string?), string? async = default(string?))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->DeleteSingleBackupById");

            // verify the required parameter 'backupId' is set
            if (backupId == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupId' when calling CollectionBackupsApi->DeleteSingleBackupById");
            ...
            localVarRequestOptions.PathParameters.Add("backupName", SolrClient.Client.ClientUtils.ParameterToString(backupName)); // path parameter
            localVarRequestOptions.PathParameters.Add("backupId", SolrClient.Client.ClientUtils.ParameterToString(backupId)); // path parameter
            if (location != null)
            {
                localVarRequestOptions.QueryParameters.Add(SolrClient.Client.ClientUtils.ParameterToMultiMap("", "location", location));
            }
        ...
        {
            SolrClient.Client.ApiResponse<BackupDeletionResponseBodyModel> localVarResponse = await DeleteSingleBackupByIdWithHttpInfoAsync(backupName, backupId, location, repository, async, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            SolrClient.Client.ApiResponse<PurgeUnusedResponseModel> localVarResponse = GarbageCollectUnusedBackupFilesWithHttpInfo(backupName, purgeUnusedFilesRequestBodyModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="purgeUnusedFilesRequestBodyModel">Request body parameters for the orphaned file cleanup (optional)</param>
        /// <returns>ApiResponse of PurgeUnusedResponseModel</returns>
        public SolrClient.Client.ApiResponse<PurgeUnusedResponseModel> GarbageCollectUnusedBackupFilesWithHttpInfo(string backupName, PurgeUnusedFilesRequestBodyModel? purgeUnusedFilesRequestBodyModel = default(PurgeUnusedFilesRequestBodyModel?))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->GarbageCollectUnusedBackupFiles");
        ...
        {
            SolrClient.Client.ApiResponse<PurgeUnusedResponseModel> localVarResponse = await GarbageCollectUnusedBackupFilesWithHttpInfoAsync(backupName, purgeUnusedFilesRequestBodyModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PurgeUnusedResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<PurgeUnusedResponseModel>> GarbageCollectUnusedBackupFilesWithHttpInfoAsync(string backupName, PurgeUnusedFilesRequestBodyModel? purgeUnusedFilesRequestBodyModel = default(PurgeUnusedFilesRequestBodyModel?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->GarbageCollectUnusedBackupFiles");
        ...
        {
            SolrClient.Client.ApiResponse<ListCollectionBackupsResponseModel> localVarResponse = ListBackupsAtLocationWithHttpInfo(backupName, location, repository);
            return localVarResponse.Data;
        }
        ...
        /// <param name="repository"> (optional)</param>
        /// <returns>ApiResponse of ListCollectionBackupsResponseModel</returns>
        public SolrClient.Client.ApiResponse<ListCollectionBackupsResponseModel> ListBackupsAtLocationWithHttpInfo(string backupName, string? location = default(string?), string? repository = default(string?))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->ListBackupsAtLocation");
        ...
        {
            SolrClient.Client.ApiResponse<ListCollectionBackupsResponseModel> localVarResponse = await ListBackupsAtLocationWithHttpInfoAsync(backupName, location, repository, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListCollectionBackupsResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<ListCollectionBackupsResponseModel>> ListBackupsAtLocationWithHttpInfoAsync(string backupName, string? location = default(string?), string? repository = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->ListBackupsAtLocation");
        ...
        {
            SolrClient.Client.ApiResponse<SubResponseAccumulatingJerseyResponseModel> localVarResponse = RestoreCollectionWithHttpInfo(backupName, restoreCollectionRequestBodyModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="restoreCollectionRequestBodyModel"> (optional)</param>
        /// <returns>ApiResponse of SubResponseAccumulatingJerseyResponseModel</returns>
        public SolrClient.Client.ApiResponse<SubResponseAccumulatingJerseyResponseModel> RestoreCollectionWithHttpInfo(string backupName, RestoreCollectionRequestBodyModel? restoreCollectionRequestBodyModel = default(RestoreCollectionRequestBodyModel?))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->RestoreCollection");
        ...
        {
            SolrClient.Client.ApiResponse<SubResponseAccumulatingJerseyResponseModel> localVarResponse = await RestoreCollectionWithHttpInfoAsync(backupName, restoreCollectionRequestBodyModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SubResponseAccumulatingJerseyResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<SubResponseAccumulatingJerseyResponseModel>> RestoreCollectionWithHttpInfoAsync(string backupName, RestoreCollectionRequestBodyModel? restoreCollectionRequestBodyModel = default(RestoreCollectionRequestBodyModel?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'backupName' is set
            if (backupName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'backupName' when calling CollectionBackupsApi->RestoreCollection");
