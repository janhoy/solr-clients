...
namespace SolrClient.Api
{
    ...
    public partial class CollectionSnapshotsApi : IDisposable, ICollectionSnapshotsApi
    {
        ...
        /// <returns></returns>
        public CollectionSnapshotsApi(SolrClient.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CollectionSnapshotsApi(HttpClient client, SolrClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CollectionSnapshotsApi(SolrClient.Client.ISynchronousClient client, SolrClient.Client.IAsynchronousClient asyncClient, SolrClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            SolrClient.Client.ApiResponse<CreateCollectionSnapshotResponseModel> localVarResponse = CreateCollectionSnapshotWithHttpInfo(collName, snapshotName, createCollectionSnapshotRequestBodyModel);
        ...
        /// <param name="createCollectionSnapshotRequestBodyModel">Contains user provided parameters</param>
        /// <returns>ApiResponse of CreateCollectionSnapshotResponseModel</returns>
        public SolrClient.Client.ApiResponse<CreateCollectionSnapshotResponseModel> CreateCollectionSnapshotWithHttpInfo(string collName, string snapshotName, CreateCollectionSnapshotRequestBodyModel createCollectionSnapshotRequestBodyModel)
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->CreateCollectionSnapshot");

            // verify the required parameter 'snapshotName' is set
            if (snapshotName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'snapshotName' when calling CollectionSnapshotsApi->CreateCollectionSnapshot");
            ...
            if (createCollectionSnapshotRequestBodyModel == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'createCollectionSnapshotRequestBodyModel' when calling CollectionSnapshotsApi->CreateCollectionSnapshot");
            ...
            localVarRequestOptions.PathParameters.Add("snapshotName", SolrClient.Client.ClientUtils.ParameterToString(snapshotName)); // path parameter
        ...
        {
            SolrClient.Client.ApiResponse<CreateCollectionSnapshotResponseModel> localVarResponse = await CreateCollectionSnapshotWithHttpInfoAsync(collName, snapshotName, createCollectionSnapshotRequestBodyModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateCollectionSnapshotResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<CreateCollectionSnapshotResponseModel>> CreateCollectionSnapshotWithHttpInfoAsync(string collName, string snapshotName, CreateCollectionSnapshotRequestBodyModel createCollectionSnapshotRequestBodyModel, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->CreateCollectionSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<DeleteCollectionSnapshotResponseModel> localVarResponse = DeleteCollectionSnapshotWithHttpInfo(collName, snapshotName, followAliases, async);
            return localVarResponse.Data;
        }
        ...
        /// <param name="async"> (optional)</param>
        /// <returns>ApiResponse of DeleteCollectionSnapshotResponseModel</returns>
        public SolrClient.Client.ApiResponse<DeleteCollectionSnapshotResponseModel> DeleteCollectionSnapshotWithHttpInfo(string collName, string snapshotName, bool? followAliases = default(bool?), string? async = default(string?))
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->DeleteCollectionSnapshot");

            // verify the required parameter 'snapshotName' is set
            if (snapshotName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'snapshotName' when calling CollectionSnapshotsApi->DeleteCollectionSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<DeleteCollectionSnapshotResponseModel> localVarResponse = await DeleteCollectionSnapshotWithHttpInfoAsync(collName, snapshotName, followAliases, async, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteCollectionSnapshotResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<DeleteCollectionSnapshotResponseModel>> DeleteCollectionSnapshotWithHttpInfoAsync(string collName, string snapshotName, bool? followAliases = default(bool?), string? async = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->DeleteCollectionSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<ListCollectionSnapshotsResponseModel> localVarResponse = ListSnapshotsWithHttpInfo(collName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="collName">The name of the collection.</param>
        /// <returns>ApiResponse of ListCollectionSnapshotsResponseModel</returns>
        public SolrClient.Client.ApiResponse<ListCollectionSnapshotsResponseModel> ListSnapshotsWithHttpInfo(string collName)
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->ListSnapshots");
        ...
        {
            SolrClient.Client.ApiResponse<ListCollectionSnapshotsResponseModel> localVarResponse = await ListSnapshotsWithHttpInfoAsync(collName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListCollectionSnapshotsResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<ListCollectionSnapshotsResponseModel>> ListSnapshotsWithHttpInfoAsync(string collName, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'collName' is set
            if (collName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'collName' when calling CollectionSnapshotsApi->ListSnapshots");
