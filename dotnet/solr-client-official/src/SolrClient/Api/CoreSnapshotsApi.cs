...
namespace SolrClient.Api
{
    ...
    public partial class CoreSnapshotsApi : IDisposable, ICoreSnapshotsApi
    {
        ...
        /// <returns></returns>
        public CoreSnapshotsApi(SolrClient.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CoreSnapshotsApi(HttpClient client, SolrClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CoreSnapshotsApi(SolrClient.Client.ISynchronousClient client, SolrClient.Client.IAsynchronousClient asyncClient, SolrClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            SolrClient.Client.ApiResponse<CreateCoreSnapshotResponseModel> localVarResponse = CreateSnapshotWithHttpInfo(coreName, snapshotName, async);
        ...
        /// <param name="async">The id to associate with the async task. (optional)</param>
        /// <returns>ApiResponse of CreateCoreSnapshotResponseModel</returns>
        public SolrClient.Client.ApiResponse<CreateCoreSnapshotResponseModel> CreateSnapshotWithHttpInfo(string coreName, string snapshotName, string? async = default(string?))
        {
            // verify the required parameter 'coreName' is set
            if (coreName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'coreName' when calling CoreSnapshotsApi->CreateSnapshot");

            // verify the required parameter 'snapshotName' is set
            if (snapshotName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'snapshotName' when calling CoreSnapshotsApi->CreateSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<CreateCoreSnapshotResponseModel> localVarResponse = await CreateSnapshotWithHttpInfoAsync(coreName, snapshotName, async, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            SolrClient.Client.ApiResponse<DeleteSnapshotResponseModel> localVarResponse = DeleteSnapshotWithHttpInfo(coreName, snapshotName, async);
            return localVarResponse.Data;
        }
        ...
        /// <param name="async">The id to associate with the async task. (optional)</param>
        /// <returns>ApiResponse of DeleteSnapshotResponseModel</returns>
        public SolrClient.Client.ApiResponse<DeleteSnapshotResponseModel> DeleteSnapshotWithHttpInfo(string coreName, string snapshotName, string? async = default(string?))
        {
            // verify the required parameter 'coreName' is set
            if (coreName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'coreName' when calling CoreSnapshotsApi->DeleteSnapshot");

            // verify the required parameter 'snapshotName' is set
            if (snapshotName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'snapshotName' when calling CoreSnapshotsApi->DeleteSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<DeleteSnapshotResponseModel> localVarResponse = await DeleteSnapshotWithHttpInfoAsync(coreName, snapshotName, async, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteSnapshotResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<DeleteSnapshotResponseModel>> DeleteSnapshotWithHttpInfoAsync(string coreName, string snapshotName, string? async = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'coreName' is set
            if (coreName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'coreName' when calling CoreSnapshotsApi->DeleteSnapshot");
        ...
        {
            SolrClient.Client.ApiResponse<ListCoreSnapshotsResponseModel> localVarResponse = ListSnapshots1WithHttpInfo(coreName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="coreName">The name of the core for which to retrieve snapshots.</param>
        /// <returns>ApiResponse of ListCoreSnapshotsResponseModel</returns>
        public SolrClient.Client.ApiResponse<ListCoreSnapshotsResponseModel> ListSnapshots1WithHttpInfo(string coreName)
        {
            // verify the required parameter 'coreName' is set
            if (coreName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'coreName' when calling CoreSnapshotsApi->ListSnapshots1");
        ...
        {
            SolrClient.Client.ApiResponse<ListCoreSnapshotsResponseModel> localVarResponse = await ListSnapshots1WithHttpInfoAsync(coreName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListCoreSnapshotsResponseModel)</returns>
        public async System.Threading.Tasks.Task<SolrClient.Client.ApiResponse<ListCoreSnapshotsResponseModel>> ListSnapshots1WithHttpInfoAsync(string coreName, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'coreName' is set
            if (coreName == null)
                throw new SolrClient.Client.ApiException(400, "Missing required parameter 'coreName' when calling CoreSnapshotsApi->ListSnapshots1");
