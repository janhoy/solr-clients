...
{
    /// <summary>
    /// ListCollectionsResponseModel
    /// </summary>
    [DataContract(Name = "ListCollectionsResponse")]
    public partial class ListCollectionsResponseModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCollectionsResponseModel" /> class.
        /// </summary>
        /// <param name="responseHeader">responseHeader.</param>
        /// <param name="error">error.</param>
        /// <param name="collections">collections.</param>
        public ListCollectionsResponseModel(ResponseHeaderModel responseHeader = default(ResponseHeaderModel), ErrorInfoModel error = default(ErrorInfoModel), Collection<string> collections = default(Collection<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListCollectionsResponseModel {\n");
