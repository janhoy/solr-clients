...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAliasPropertiesApi>();
            CreateOrUpdateAliasPropertyApiResponse apiResponse = await api.CreateOrUpdateAliasPropertyAsync("todo");
            SolrJerseyResponse model = apiResponse.Ok();
        }
...
- appName: v2 API
- appVersion: 9.8.1
- appDescription: OpenAPI spec for Solr&#39;s v2 API endpoints
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {013E3947-2BFD-4C76-A46D-66C4FA054D16}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
